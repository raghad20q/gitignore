...
Original file is located at
    https://colab.research.google.com/drive/14YEj-PqqrkmJMcBO2Is_Z__aJPuiNGUr
"""
...
Enter 'all', 'monday', 'tuesday', etc: ''').lower()
    ...
    return df
    [١٢:٠٣ ص، ٢٠٢٢/١١/٢٧] Raghad: def time_stats(df):
...
[١٢:٠٣ ص، ٢٠٢٢/١١/٢٧] Raghad: most_combine_stations =  combine_stations.size().sort_values(ascending = False).head(1)
